...
|49 | EP| ODJ|L'ODJ parle d'une réunion pour le 03/ 11, les thèmes ne sont pas à jour !! Pas de CR disponible pour la semaine 49.  Note : 0,2/3     Note appel Offre :11,64/20 (avec malus surnotation des autres équipes !) |0,2/3
|50 |EP | Pas d'ODJ ni CR pour la semaine 50| 0/3|
| | | | |
| | | | |
|====
