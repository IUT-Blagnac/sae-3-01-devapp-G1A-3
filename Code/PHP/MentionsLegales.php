...
<body style="background-color: #ffe4e1;">
	...
	<div class="container">
        <div class="row">
            <h1 class="fw-bold text-danger">Mentions Légales</h1>
			<div>
				<hr>
				...
				<strong>Fonction :</strong> Directeur<br>
				<br>
				...
				<br>
				<h2>Copyright</h2>
				Ce site web est protégé par la législation française actuellement en vigueur, contenue dans le Code de la propriété intellectuelle.<br>
				Le contenu du site (SweetShops) est protégé par le droit d'auteur et les droits de propriété intellectuelle.<br>
				Toute reproduction, représentation, modification ou adaptation totale ou partielle du site, ou de l’un de ses éléments, sans autorisation préalable est interdite.<br>
				<br>
				<h2>Protection des données personnelles</h2>
				En conformité avec le RGPD et la loi n° 78-17 du 6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés, vous disposez des droits suivants concernant vos données personnelles :
				<li>Droit d'accès</li>
